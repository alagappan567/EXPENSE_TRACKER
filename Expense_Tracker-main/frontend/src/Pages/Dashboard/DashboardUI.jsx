      ...
      <Box sx={outerDashboard}>
        <Box sx={dashboardUpper}>
          ...
          <Grid container spacing={"80px"}>
              ...
              <Box>
                ...
                <Box mt={"15px"} sx={expanseOuter}>
                  ...
                  {!loading && expanseData && expanseData.total == 0 && (
                    <>
                      <Box
                        sx={{ ...center, height: "30vh", marginTop: "15px" }}
                      >
                        <DashboardPlaceholder />
                      </Box>
                    </>
            ...
            <Grid item xs={6}>
              <Box sx={recentExpanse}>
                <Typography variant="h3">Expenditure</Typography>
                <Select
                ...
                >
                  <MenuItem value="WEEK_DAYS_DATA" defaultChecked>
                    this week
                  </MenuItem>
                ...
                {PieChartData.length > 0 && (
                  <>
                    <Box sx={expanseOuter}>
                      ...
                      {pieChartDuraction ==
                        GRAPHICAL_VIEW_DURATION.MONTH_DAYS_DATA && (
                        <PieChart width={400} height={200}>
                          <Pie
                            data={monthChartData}
                            cx={125}
                      ...
                      {pieChartDuraction ==
                        GRAPHICAL_VIEW_DURATION.MONTHLY_DATA && (
                        <PieChart width={400} height={200}>
                          <Pie
                            data={yearChartData}
                            cx={125}
        ...
        <Box sx={dashboardDown}>
          <Box>
            <Box sx={recentExpanse}>
              <Typography variant="h3">Spending summary</Typography>
              <Select
                labelId="demo-customized-select-label"
                id="demo-customized-select"
                ...
                >
                  ...
                  <Box sx={{ width: "320px" }}>
                    ...
                    <Typography variant="p">
                      Your spending summary will appear on this section. Head
                      over to the Transactions tab and click the “Add new”
